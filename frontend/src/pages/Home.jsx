import { Button, Container, Typography, Grid, Paper, Snackbar, Alert } from '@mui/material';
...
export default function Home() {
  const { showLogoutMessage, clearLogoutMessage } = useAuth();
  ...
  return (
    <div className="home-root">
      ...
      <Snackbar
        ...
        onClose={handleCloseLogoutMessage}
      ...
      >
        ...
        >
          You've successfully logged out of ShikshaSetu. Come back soon!
        </Alert>
      </Snackbar>
