          ...
          <Card className="profile-card">
            <CardContent className="profile-picture-section">
              <Box className="profile-picture-container">
                ...
                >
                  <Avatar
                    src={isEditing ? editData.personalInfo?.profilePicture : educatorData.personalInfo?.profilePicture || ''}
                    alt={isEditing ? editData.personalInfo?.name : educatorData.personalInfo?.name || ''}
